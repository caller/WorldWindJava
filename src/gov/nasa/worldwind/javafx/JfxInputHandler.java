...
public class JfxInputHandler extends WWObjectImpl implements InputHandler
{
    ...
    private final EventHandler<KeyEvent> keyTypedHandler = new EventHandler<KeyEvent>()
    {
        @Override
        public void handle(KeyEvent event)
        {
    ...
    private final EventHandler<MouseEvent> mouseReleasedHandler = new EventHandler<MouseEvent>()
    {
        ...
        public void handle(MouseEvent event)
        {
            ...
            java.awt.event.MouseEvent mouseEvent = convertFxToAwtEvent(event, java.awt.event.MouseEvent.MOUSE_RELEASED);
    ...
    private final EventHandler<MouseEvent> mouseMovedHandler = new EventHandler<MouseEvent>()
    {
        @Override
        public void handle(MouseEvent event)
        {
            ...
            mousePoint = convertMousePoint(event);
            java.awt.event.MouseEvent mouseEvent = convertFxToAwtEvent(event, java.awt.event.MouseEvent.MOUSE_MOVED);
    ...
    private final EventHandler<ZoomEvent> zoomHandler = new EventHandler<ZoomEvent>()
    {
        @Override
